...
{
	// Implementação FCFS:
	// Tanto processos de usuário quanto processos vitais do 
	// sistema (microkernel) terão seu quantum renovado.
    // Nenhum processo sofre preempção por tempo, rodando até terminar
    // ou se bloquear voluntariamente.
